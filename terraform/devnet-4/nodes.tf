...
variable "nodes" {
  ...
  default = [
    ...
    { name = "lighthouse-geth", count = 1, cloud = "hetzner", validator_start = 0, validator_end = 100 },
    { name = "lighthouse-nethermind", count = 1, cloud = "hetzner", validator_start = 100, validator_end = 200 },
    { name = "lighthouse-reth", count = 1, cloud = "hetzner", validator_start = 200, validator_end = 300 },
    { name = "prysm-geth", count = 1, cloud = "hetzner", validator_start = 300, validator_end = 400 },
    { name = "nimbus-besu", count = 1, cloud = "hetzner", validator_start = 400, validator_end = 500 },
    { name = "teku-erigon", count = 1, cloud = "hetzner", validator_start = 500, validator_end = 600 },
  ]
}
